...
- [**editorConfig**](./config/editor/editor.md) - defines parameters pertaining to the editor interface: opening mode (viewer or editor), interface language, additional buttons, etc.;
  ...
  - [**plugins**](./config/editor/plugins.md) - is used to connect the necessary [plugins](../../plugin-and-macros/getting-started/overview.md) to your ONLYOFFICE Docs, so that they become visible to all document editor users;
