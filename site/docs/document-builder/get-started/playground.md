...
- **Script testing**. Write and run JavaScript code using one of the provided ONLYOFFICE APIs ([Office JavaScript API](../../office-api/get-started/overview.md), [Automation API](../../docs-api/usage-api/automation-api.md), or [Plugins API](../../plugin-and-macros/getting-started/overview.md)).
...
<PlaygroundCardsRow searchParams={[{testType: "builder"}, {document: "sample"}]}/>
```