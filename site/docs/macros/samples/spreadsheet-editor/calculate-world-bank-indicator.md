...
Creates an [asynchronous custom function](/docs/macros/macros/adding-custom-functions#asynchronous-functions) to calculate a World Bank indicator value for a specific year.
