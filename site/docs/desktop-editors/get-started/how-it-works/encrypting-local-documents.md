...
More information about the plugin structure can be found [here](../../../plugin-and-macros/plugins/fundamentals/configuration/config-json.md).
...
All the config parameters are described in the [documentation](../../../plugin-and-macros/plugins/fundamentals/configuration/config-json.md).
...
As we can see from the code above, all files will be encrypted with one password - *\{my-super-long-password\}*. The [OnEncryption](../../../plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/OnEncryption.md), [StartAction](../../../plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/StartAction.md), [EndAction](../../../plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/EndAction.md) methods can be found in the **Plugins and macros API documentation**.
...
Detailed instructions can be found [here](../../../plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md).
