...
- How to use [AI tools](../ai/ai-plugin.md), add [custom providers](../ai/custom-providers.md), configure [AI agent](../ai/ai-agent.md), create [custom tools](../ai/custom-ai-tools.md), and work with [text annotations](../ai/text-annotations-guide.md)
...
- Where to find guides and [plugin](../samples/plugin-samples/plugin-samples.md)/[macro](../samples/macro-samples/macro-samples.md)/[custom AI tool](../samples/custom-ai-tools/custom-ai-tools.md) code samples to get started
