...
2. Follow the [Plugin development tutorial](../../../plugins/fundamentals/getting-started/your-first-plugin.md) to scaffold your own version from scratch.
3. Reference the [Plugin structure](../../../plugins/fundamentals/configuration/config-json.md) documentation to understand how `config.json`, `index.html`, and `code.js` fit together.
