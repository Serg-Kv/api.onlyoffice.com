...
In the [ONLYOFFICE Docs config](../../../../../docs-api/usage-api/config/editor/plugins.md), add the URL to your plugin's `config.json` file in the `plugins.pluginsData` parameter:
