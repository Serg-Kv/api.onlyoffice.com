...
This example demonstrates how to create a task management table using the DocSpace Embed SDK. When a task is created, a corresponding room is automatically created in DocSpace.
