...
宏是一种小型脚本，可帮助您在处理不同类型文档的日常工作中提高效率。ONLYOFFICE 宏使用 JavaScript 语法和 [Office JavaScript API](/docs/office-api/get-started/overview) 脚本规范。
...
4. 查阅 [API 文档](/docs/office-api/get-started/overview)来编写脚本。
...
若要添加更多宏，请点击![加号图标](/assets/images/plugins/plus.svg#gh-light-mode-only)![加号图标](/assets/images/plugins/plus.dark.svg#gh-dark-mode-only)。

如需删除不再需要的宏，请点击宏名称旁边的![三点图标](/assets/images/plugins/dots.svg#gh-light-mode-only)![三点图标](/assets/images/plugins/dots.dark.svg#gh-dark-mode-only)并选择**删除**。

如要复制宏，请点击宏名称旁边的![三点图标](/assets/images/plugins/dots.svg#gh-light-mode-only)![三点图标](/assets/images/plugins/dots.dark.svg#gh-dark-mode-only)图标然后选择**复制**。
